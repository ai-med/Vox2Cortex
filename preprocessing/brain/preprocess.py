...
OASIS_DIR = '/mnt/nas/Data_Neuro/JADNI/FS_53/'
# Output directory
SAVE_DIR = '/mnt/nas/Data_Neuro/JADNI/registered_output_mni152/FS53/'
SURFACES = ['lh_pial', 'lh_white', 'rh_pial', 'rh_white']
MNI_TEMPLATE_FILE = '/mnt/nas/Data_Neuro/mni_templates/MNI152_T1_1mm.nii.gz'

###########################################################

with open('/mnt/nas/Data_Neuro/JADNI/registered_output_mni152/FS53/wrong_shape.txt') as f:
